...
<div class="admin menu">
	<div class="wrapper">
		<div class="small">
			<div class="button margin10"><a href="{{route('admin.menu.index')}}" class="btn btn-block btn-primary">Go back</a></div>
		</div>
		<div class="big">
			<form action="{{route('admin.menu.create')}}" method="POST" role="form">
				...
				<div class="fc-grp">
					<label>Title</label>
					<input name="title" type="text" class="fc-in" id="" placeholder="Enter title">
				</div>
				
				<div class="fc-grp">
					<label for="">Slug</label>
					<input name="slug" type="text" class="fc-in" id="" placeholder="Enter menu slug">
				</div>

				<div class="form-group">
					<label for="">For</label>
					<select name="app" class="fc-select">
