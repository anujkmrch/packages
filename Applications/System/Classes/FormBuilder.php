  ...
  function build($request = null) {
    ...
    foreach ($this->elements as $name => $elements) {
      ...
      switch ($elements['type']) {
        case 'textarea':
          $input = "<textarea class=\"fc-in\" name=\"{$name}\">{$value}</textarea>";
          break;
        case 'email':
        case 'password':
        case 'text':
        case 'number':
          $input = "<input class=\"fc-in\" name=\"{$name}\" type=\"{$elements['type']}\" value=\"{$value}\" />";
          break;
        ...
        case 'select':
        	...
        	$input = '<select class="fc-in" name="' . $name . '"'.$extra.'>';
        	$input .= $information;
        	$input .= "</select>";
        ...
        case 'submit':
          $input = '<input type="submit" class="fc-btn" name="' . $name . '" value="' . $elements['title'] . '">';
          $label = '';
          break;
